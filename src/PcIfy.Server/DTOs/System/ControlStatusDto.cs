...
public record BatteryStatusDto(int Level, bool Charging, bool Available, int TemperatureCelsius, bool TemperatureAvailable);
...
public record ClipboardStatusDto(string Text, string Format, bool Available);
public record AppInfoDto(string Id, string Name, string? IconKey, bool Running);
public record AppLauncherStatusDto(List<AppInfoDto> Apps, bool Available);
